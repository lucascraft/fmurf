...
void Particle::update() {
	...
	vx = myApp->fluidSolver.getVelXAtCell(fluidIndex) * myApp->window.width * mass * FLUID_FORCE + vx * MOMENTUM;
	vy = myApp->fluidSolver.getVelYAtCell(fluidIndex) * myApp->window.height * mass * FLUID_FORCE + vy * MOMENTUM;
