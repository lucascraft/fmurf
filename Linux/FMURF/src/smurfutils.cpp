...
//
Smuon* SmurfUtils::getCloserSmuonWithinGivenRadiusAndKind(vector<Smurf*> *smurfs, vector<SmurFinger*> *fingers, ofxTuioContainer *tuioObj, float radius, CloserEnum _discriminationKind ) {
	float dist = FLT_MAX;
	Smuon *smuon = NULL;
...
SmurfAnchor* SmurfUtils::createSmurfAnchor(Smuon* smuon, float _ownerId, AnchorKind _anchorKind) {
	...
	SmurfAnchor *smurfAnchor = new SmurfAnchor(_ownerId, tuioObj, SMURF_KIND_ANCHOR, _anchorKind);
